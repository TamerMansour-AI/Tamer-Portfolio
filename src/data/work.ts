...
const workSeed: WorkSeedItem[] = [
  ...
  },
  {
    ...
    desc_en:
      "A client-safe proof page for Upwork production work, including a clean web-optimized English Anbiya Visuals montage and Tamer's manually edited Arabic edition for the Arabic page, plus avatar workflow framing. Public copy keeps the capability visible while avoiding full client deliverables, scripts, private feedback, or identity-sensitive avatar assets.",
    desc_ar:
      "صفحة إثبات آمنة لعمل إنتاجي عبر Upwork، تتضمن النسخة العربية التي حررها تامر من مونتاج Anbiya Visuals، إلى جانب صياغة آمنة لسير عمل الأفاتار من دون كشف التسليمات الكاملة أو المواد الخاصة.",
    ...
    note_en: "English route uses the clean original montage; Arabic route uses Tamer's manually edited Arabic version.",
    note_ar: "النسخة الإنجليزية تعرض المونتاج الأصلي النظيف، والنسخة العربية تعرض تحرير تامر العربي اليدوي.",
