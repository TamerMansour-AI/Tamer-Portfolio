...
const workSeed: WorkSeedItem[] = [
  ...
  },
  {
    ...
    desc_en:
      "A client-safe proof page for Upwork production work, including a web-optimized Anbiya Visuals montage and an Arabic card edition for the Arabic page, plus avatar workflow framing. Public copy keeps the capability visible while avoiding full client deliverables, scripts, private feedback, or identity-sensitive avatar assets.",
    desc_ar:
      "صفحة إثبات آمنة لعمل إنتاجي عبر Upwork، تتضمن نسخة عربية من مونتاج Anbiya Visuals ببطاقات إدخال سينمائية، إلى جانب صياغة آمنة لسير عمل الأفاتار من دون كشف التسليمات الكاملة أو المواد الخاصة.",
    ...
    note_en: "Includes a 2:10 client-safe website edition, with the Arabic route using designed Arabic title-card insertions.",
    note_ar: "تتضمن نسخة عربية مدتها 2:10 تستبدل بطاقات العرض الإنجليزية ببطاقات عربية مصممة.",
