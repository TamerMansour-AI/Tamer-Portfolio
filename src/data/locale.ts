...
export type RouteKey = "home" | "work" | "ways" | "workshops" | "lab" | "archive" | "about" | "contact" | "privacy";
...
export const navLabels: Record<Locale, Record<RouteKey, string>> = {
  en: { home: "Home", work: "Work", ways: "Ways to work", workshops: "Workshops", lab: "Lab", archive: "Archive", about: "About", contact: "Contact", privacy: "Privacy" },
  ar: { home: "الرئيسية", work: "الأعمال", ways: "طرق التعاون", workshops: "الورشات", lab: "المختبر", archive: "الأرشيف", about: "عن تامر", contact: "تواصل", privacy: "الخصوصية" }
};
